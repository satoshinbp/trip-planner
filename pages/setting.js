    ...
    <div style={{ minHeight: "100vh", position: "relative" }}>
      ...
      <Container maxWidth="lg" className={classes.paddingBottomForFooter}>
            ...
            <AccordionDetails>
              ...
              <Grid container direction="column">
                <Typography variant="body1">
                  You are currently signed in as a guest. If you sign up a new account, you can save your trips
                  permanently.
                </Typography>
                ...
                <RadioGroup onChange={(e) => setSignUp({ ...signUp, method: e.target.value })}>
                  ...
                  <FormControlLabel value="email" control={<Radio color="primary" />} label="E-mail and Password" />
                </RadioGroup>
                {signUp.method === "email" ? (
                  <React.Fragment>
                    <Grid item>
            ...
            {provider.includes("password") ? (
              <React.Fragment>
                <Accordion expanded={isExpanded === "email"} onChange={handleChangePanel("email")}>
                  ...
                  <Divider />
                  <AccordionActions>
                    <Button size="small" color="primary" onClick={handleChangeEmail}>
                      Save
                    </Button>
                  </AccordionActions>
                </Accordion>
            ...
            <Accordion expanded={isExpanded === "delete"} onChange={handleChangePanel("delete")}>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                ...
                <Box>
                  ...
                  <Hidden xsDown>
                    <Typography className={classes.secondaryHeading}>Deleting your account is permanent.</Typography>
                  </Hidden>
                </Box>
              </AccordionSummary>
              <AccordionDetails>
              ...
              <AccordionActions>
                <Button
                  size="small"
                  color="secondary"
                  onClick={() => setDeleteAccount({ ...deleteAccount, open: true })}
                >
                  Delete
                </Button>
              </AccordionActions>
        ...
        <Dialog open={deleteAccount.open} onClose={() => setDeleteAccount({ ...deleteAccount, open: false })}>
          ...
          <DialogContent>
            <DialogContentText>Are you sure you want to permanently delete this accout?</DialogContentText>
            {provider.includes("password") ? (
              <TextField
                variant="outlined"
                margin="normal"
