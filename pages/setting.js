...
export default withAuth((props) => {
  ...
  const handleChangeEmail = () => {
    ...
    user
      ...
      .then((result) => {
        user
          .updateEmail(changeEmail.address)
          .then(() => {
            setIsLoading(false)
            setIsExpanded(false)
            setResult({
  ...
  const handleCloseResult = () =>
    setResult({ open: false, error: false, message: '' })

  const handleChangePanel = (panel) => (e, expanded) =>
      ...
      <Container maxWidth="lg" className={classes.paddingBottomForFooter}>
        ...
        {user.isAnonymous ? (
            ...
            <AccordionDetails>
              ...
              <Grid container direction="column">
                <Typography variant="body1">
                  You are currently signed in as a guest. If you sign up a new
                  account, you can save your trips permanently.
                </Typography>
                <Typography variant="body1">Sign up with...</Typography>
                <RadioGroup
                  onChange={(e) =>
                    setSignUp({ ...signUp, method: e.target.value })
                  }
                >
                  <FormControlLabel
                    value="google"
          ...
          <React.Fragment>
            {provider.includes('password') ? (
              <React.Fragment>
                <Accordion
                  ...
                  onChange={handleChangePanel('email')}
                >
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    <ListItemIcon className={classes.icon}>
                ...
                <Accordion
                  ...
                  onChange={handleChangePanel('password')}
                >
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    <ListItemIcon className={classes.icon}>
            ...
            <Accordion
              expanded={isExpanded === 'delete'}
              onChange={handleChangePanel('delete')}
            >
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <ListItemIcon className={classes.icon}>
              ...
              <AccordionDetails>
                ...
                <Typography variant="body2">
                  When you delete your Trip Planner account, you won't be able
                  to retrieve the content or information you've shared on Trip
                  Planner.
                </Typography>
              </AccordionDetails>
              <Divider />
              <AccordionActions>
                <Button
                  ...
                  color="secondary"
                  onClick={() =>
                    setDeleteAccount({ ...deleteAccount, open: true })
                  }
                >
                  Delete
                </Button>
        ...
        <Dialog
          ...
          onClose={() => setDeleteAccount({ ...deleteAccount, open: false })}
        >
          ...
          <DialogContent>
            ...
            {provider.includes('password') ? (
              <TextField
                ...
                type="password"
                onChange={(e) =>
                  setDeleteAccount({ ...deleteAccount, pass: e.target.value })
                }
              />
            ) : null}
          </DialogContent>
